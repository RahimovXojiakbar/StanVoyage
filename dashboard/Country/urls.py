...
urlpatterns = [
    ...
    path('location/create/<str:uuid>/', views.location_create, name='location_create'),

    path('location/image/create/<str:uuid>/', views.location_image_create, name='location_image_create'),
